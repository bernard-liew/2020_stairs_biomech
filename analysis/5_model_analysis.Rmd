...
form_scale = "~ ba (~ s(cycle, by = study))"
```
...
bamlss_model_ankle <-  bamlss (f,
                              ...
                              thin = 1,
                              binning = TRUE)
saveRDS(bamlss_model_ankle, "output/bamlss_finalmod2_ankle.RDS")
...
bamlss_model_knee <-  bamlss (f,
                              ...
                              thin = 1,
                              binning = TRUE)
saveRDS(bamlss_model_knee, "output/bamlss_finalmod2_knee.RDS")
...
bamlss_model_hip <-  bamlss (f,
                              ...
                              thin = 1,
                              binning = TRUE)
saveRDS(bamlss_model_hip, "output/bamlss_finalmod2_hip.RDS")
