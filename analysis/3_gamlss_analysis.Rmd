...
df_ankle[c("study","subj","sex")] <- lapply(df_ankle[c("study","subj","sex")], as.factor)

m1 <- gamlss(as.formula(paste0("val ", form_right)),
             sigma.fo = as.formula(form_right),
             family = NO(),
             data = df_ankle,
             trace = FALSE)
...
df_knee[c("study","subj","sex")] <- lapply(df_knee[c("study","subj","sex")], as.factor)
...
df_hip[c("study","subj","sex")] <- lapply(df_hip[c("study","subj","sex")], as.factor)
